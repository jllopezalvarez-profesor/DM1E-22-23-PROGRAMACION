package es.iesclaradelrey.dm1e2223.ut05.ejercicios.arrays2D;
...
public class Ejercicio01 {
	...
	public static int sumarFilas(int[][] numeros, int numFila) {
		int suma = 0;
	...
	public static int sumarColumnas(int[][] numeros, int numColumna) {
		int suma = 0;
