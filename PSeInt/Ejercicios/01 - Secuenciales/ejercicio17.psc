...
//Tengo que saber también el tiempo en segundos que ha tardado en llegar. 
...
//4 Le sumo los segundos que ha tardado (necesito una variable segfinal)
...
Proceso CalcularHoraLlegada
	...
	horallegada <- trunc(segfinal / 3600); // Horas
	minllegada <- trunc((segfinal % 3600) / 60); // Minutos
	segllegada <- (segfinal % 3600) % 60; // Segundos
